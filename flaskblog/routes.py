...
# seeing the all posts of the respective user
...
#     msg=Message('Password Reset Request',sender='varunkumar8823@gmail.com',recipients=[user.email])
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(f'Your password has been updated! Your now able to log in', 'success')
        return redirect(url_for('login'))
